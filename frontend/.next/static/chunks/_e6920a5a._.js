    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Chat.useEffect": ()=>{
            ...
            const fetchCurrentUser = {
                "Chat.useEffect.fetchCurrentUser": async ()=>{
                    try {
            ...
            }["Chat.useEffect.fetchCurrentUser"];
            fetchCurrentUser();
            ...
            if (socket && currentUser && selectedUser) {
                ...
                const fetchMessages = {
                    "Chat.useEffect.fetchMessages": async ()=>{
                        try {
                            const response = await fetch("http://localhost:5000/api/messages/".concat(selectedUser._id), {
                                headers: {
